...
import application.models._MutasiModel;
import recite18th.library.Db;

public class MutasiModel extends _MutasiModel {
    ...
    public void overrideDefaultValue(Model model) {
        ...
        MutasiModel mutasiModel = (MutasiModel) model;
        mutasiModel.setNip(pegawaiTerpilih.getNip());
    }
}
