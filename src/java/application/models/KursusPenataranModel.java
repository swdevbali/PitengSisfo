...
public class KursusPenataranModel extends _KursusPenataranModel {

    public KursusPenataranModel() {
        super();
    }
    ...
    public void overrideDefaultValue(Model model) {
        ...
        KursusPenataranModel kursusPenataranModel = (KursusPenataranModel) model;
        kursusPenataranModel.setNip(pegawaiTerpilih.getNip());
    }
}
