...
public class NaikPangkatModel extends _NaikPangkatModel {

    public NaikPangkatModel() {
        super();
    }
    ...
    public void overrideDefaultValue(Model model) {
        ...
        NaikPangkatModel naikPangkatModel = (NaikPangkatModel) model;
        naikPangkatModel.setNip(pegawaiTerpilih.getNip());
    }
}
