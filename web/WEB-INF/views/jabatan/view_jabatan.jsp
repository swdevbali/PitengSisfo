...
<a href="<%=Config.base_url%>index/Jabatan/input/-1">Tambah Data</a> | </c:if>
<a href="<%=Config.base_url%>index/Jabatan/print/print" target="_blank">Cetak</a> |
<a href="<%=Config.base_url%>index/Jabatan/print/download">Download</a>
