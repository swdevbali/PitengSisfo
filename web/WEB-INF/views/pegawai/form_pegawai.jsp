...
<tr><td colspan="2">
    <c:if test="${model.foto!=null}">
      <img src="<%=Config.base_url%>upload/${model.foto}" width="139" height="103"/>    </c:if>
...
<tr>
<td><span class="style1">Agama</span></td>
<td>
...
<tr>
<td><span class="style1">Golongan Darah</span></td>
<td>
...
<tr>
<td><span class="style1">Status Perkawinan</span></td>
<td>
...
<tr>
<td><span class="style1">Pendidikan Terakhir</span></td>
<td>
...
<tr>
<td><span class="style1">Status Kepegawaian</span></td>
<td>
<select name="status_kepegawaian" id="status_kepegawaian">
	...
	<option <c:if test="${model.status_kepegawaian=='Pensiun'}">selected="selected" </c:if> value=Pensiun>Pensiun</option>
        <option <c:if test="${model.status_kepegawaian=='Honorer'}">selected="selected" </c:if> value=Honorer>Honor</option>
</select>

</td>
</tr>
<tr>
<td><span class="style1">Pangkat Golongan/Ruang</span></td>
<td>
...
<tr>
<td><span class="style1">No.SK</span></td>
<td>
<input name="no_sk" type="text" id="no_sk" value="${model.no_sk}"/>
</td>
</tr>
<tr>
<td><span class="style1">Tgl mulai Kerja</span></td>
<td>
...
<tr>
<td><span class="style1">Kode Sub Unit Kerja</span></td>
<td>
